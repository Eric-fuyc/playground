...
insert into files (id, file_name, user_id, status) values (3, 'btest.txt', 3, 1);

insert into shares (id, file_id, user_id, status) values (1, 1, 2, 0);
insert into shares (id, file_id, user_id, status) values (2, 1, 3, 1);
insert into shares (id, file_id, user_id, status) values (3, 2, -1, 0);
insert into shares (id, file_id, user_id, status) values (4, 3, -1, 0);
